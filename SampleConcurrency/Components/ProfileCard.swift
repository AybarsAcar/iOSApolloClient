...
struct ProfileCard: View {
  ...
  var body: some View {
    ...
    .task {
      await description.update(with: "I love SwiftUI and coding")
...
struct ProfileCard_Previews: PreviewProvider {
  static var previews: some View {
    let previewAddress = Address(street: "Coder St", suite: "200", city: "Developer City", zipcode: "90566-7771", geo: Geo(lat: "-43.9509", lng: "-34.4618"))
    
    let previewCompany = Company(name: "Design+Code", catchPhrase: "Design and code", bs: "Learn design and code")
    
    let previewUser = User(id: 1, name: "Stephanie", username: "stephdiep", email: "stephanie@designcode.io", address: previewAddress, phone: "123-456-7890", website: "designcode.io", company: previewCompany)
